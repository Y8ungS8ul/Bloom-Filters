...
void CSV_BLOOM() {
    // ==================== ИНИЦИАЛИЗАЦИЯ ОКНА ====================
    // Создание окна с разрешением 1280x720
    RenderWindow Options(VideoMode(1280, 720), L"Анализ CSV с фильтром Блума", Style::Default);
    
    // Установка view с разрешением 1920x1080
    ...
    // ==================== НАСТРОЙКА ФОНА ====================
    // Используем размеры view для фона
    float width = view.getSize().x;   // = 1920
    float height = view.getSize().y;  // = 1080
    
    RectangleShape background_opt(Vector2f(width, height));
    ...
    // Позиционирование кнопок (координаты в системе view 1920x1080)
    sprite1.setPosition(100, 900);
    sprite2.setPosition(350, 900);
    sprite3.setPosition(600, 900);
    sprite4.setPosition(850, 900);
    back_sprite.setPosition(95, 820);
    ...
    labels[0].setup(font, 170, 1020, L"Назад");
    labels[1].setup(font, 430, 1020, L"CSV*");
    labels[2].setup(font, 650, 1020, L"HF - C-count*");
    labels[3].setup(font, 895, 1020, L"SBF - C-count*");
    
    // ==================== ПАНЕЛЬ УПРАВЛЕНИЯ ====================
    sf::RectangleShape control_panel(sf::Vector2f(900, 300));
    control_panel.setPosition(1000, 750);
    ...
    for (int i = 0; i < 3; ++i) {
        ...
        panel_texts[i].setPosition(1030, 800 + i * 30);
    ...
    panel_sprite.setPosition(1000, 750);
    ...
    while (Options.isOpen()) {
        ...
        // ==================== РЕЖИМ 2: ДИАГРАММА КОЛЛИЗИЙ ОТ ЧИСЛА ХФ ====================
            ...
            title_sub.setPosition(1920 / 2 - 650, 120);
        ...
        // ==================== РЕЖИМ 3: ДИАГРАММА КОЛЛИЗИЙ ОТ РАЗМЕРА ====================
            ...
            title_sub.setPosition(1920 / 2 - 600, 120);
